...
// FormData 객체를 생성하여 이미지와 데이터를 함께 전송하는 함수
const createFormData = (params: TWriteSchema): FormData => {
  ...
  // 데이터를 객체로 구성하여 JSON 문자열로 변환 후 추가
  const data = {
...
export const postRegister = async (params: TWriteSchema) => {
