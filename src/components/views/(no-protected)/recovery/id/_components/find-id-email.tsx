...
import { usePostFindIdEmailCertification } from '@/hooks/auth/find/id/usePostFindIdEmailCertification';
import { usePutFindIdEmailCertificationCheck } from '@/hooks/auth/find/id/usePutFindIdEmailCertificationCheck';
...
const FindIdEmail = () => {
  ...
  const { mutateAsync: postFindIdCertification } =
    usePostFindIdEmailCertification(); // 인증번호 요청
  const { mutateAsync: putFindIdCertificationCheck } =
    usePutFindIdEmailCertificationCheck(); // 인증번호 확인
