...
>(({ className, disableOverlayClick, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'default-layout-content fixed inset-0 z-50 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  'default-layout-content rounded-t-[32px] fixed z-50 gap-4 bg-white transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
