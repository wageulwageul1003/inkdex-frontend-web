...
function WheelPicker<T extends WheelPickerValue = string>({
  ...
  return (
    <WheelPickerPrimitive.WheelPicker
      classNames={{
        optionItem: 'font-xxxl-2 text-gray-05',
        highlightWrapper: cn(
          'font-xxxl-2 bg-white text-black dark:bg-zinc-800 dark:text-zinc-50',
          'data-rwp-focused:ring-2 data-rwp-focused:ring-gray-02 data-rwp-focused:ring-inset dark:data-rwp-focused:ring-zinc-600',
        ),
        ...classNames,
      }}
      {...props}
